...
#        fi
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://github.com/bitwar0x/aireverse/releases/latest/download/soga-linux-${arch}.tar.gz
        if [[ $? -ne 0 ]]; then
    ...
    curl -o /usr/bin/soga -Ls https://raw.githubusercontent.com/bitwar0x/aireverse/main/soga.sh
    chmod +x /usr/bin/soga
    curl -o /usr/bin/soga-tool -Ls https://raw.githubusercontent.com/bitwar0x/aireverse/main/soga-tool-${arch}
